...
class NotaneitorApplicationTests {
    ...
    @Order(14)
    public void PR12() {
        PO_PrivateView.refactorLogging(driver, "99999990A", "Notas del usuario", "123456");
    ...
    @Order(16)
    public void PR14() {
        PO_PrivateView.refactorLogging(driver, "99999993D", "99999993D", "123456");
        //Pinchamos en la opción de menú de Notas: //li[contains(@id, 'marks-menu')]/a
        PO_PrivateView.refactorCheck(driver, 0, "//li[contains(@id, 'marks-menu')]/a");
        //Esperamos a que aparezca la opción de añadir nota: //a[contains(@href, 'mark/add')]
        PO_PrivateView.refactorCheck(driver, 0, "//a[contains(@href, 'mark/add')]");
        ...
        PO_PrivateView.refactorCheck(driver, 3, "//a[contains(@class, 'page-link')]");
    ...
    public void PR15() {
        ...
        PO_PrivateView.refactorCheck(driver, 0, "//a[contains(@href, 'mark/list')]");
        //Esperamos a que se muestren los enlaces de paginación la lista de notas
        PO_PrivateView.refactorCheck(driver, 3, "//a[contains(@class, 'page-link')]");
        //Esperamos a que aparezca la Nueva nota en la última página
        //Y Pinchamos en el enlace de borrado de la Nota "Nota Nueva 1"
        PO_PrivateView.refactorCheck(driver, 0, "//td[contains(text(), 'Nota Nueva 1')]/following-sibling::*/a[contains(@href, 'mark/delete')]");
